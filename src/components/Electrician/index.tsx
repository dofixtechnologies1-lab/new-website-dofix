...
import ElectricianSingleGridItem from "../Shop/electricianSingleGridItem";
// import SingleListItem from "../Shop/SingleListItem";
import CustomSelect from "../ShopWithSidebar/CustomSelect";

import ElectricianData from "../Shop/electricianData";
            ...
            <div className="w-full">
              ...
              >
                {filteredServices.map((item, key) =>
                  productStyle === "grid" ? (
                    <ElectricianSingleGridItem item={item} key={key} />
                  ) : (
                    <ElectricianSingleGridItem item={item} key={key} />
                  )
                )}
